  ...
  return (
    <div className="mb-8 w-full">
      <div className="flex w-full flex-col items-center mb-4">
        <h3 className="text-2xl md:text-4xl text-center font-bold mb-4">Book Selection</h3>
        {group.book == null && (
          <div className="w-full flex flex-col items-center mt-3 mb-4">
            <div className="w-full flex-col md:flex-row items-center md:w-3/4 space-y-2 md:space-x-3 p-2 mb-8 text-center rounded-lg">
